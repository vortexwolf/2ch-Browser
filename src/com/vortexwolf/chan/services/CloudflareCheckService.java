...
public class CloudflareCheckService {
    ...
    private IPostSendView mPostSendView = null;
    private String url;
	...
	if (mPostSendView != null) mPostSendView.showError(message);
    ...
    public CloudflareCheckService(String url, Activity activity, IPostSendView postSendView) {
	this(url, activity);
	this.mPostSendView = postSendView;
    }
