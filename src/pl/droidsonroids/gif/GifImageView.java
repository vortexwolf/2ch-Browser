//modified by miku-nyan: setBackground call moved to CompatibilityUtilsImpl for compatibility with the oldest APIs
    ...
    void setResource(boolean isSrc, int resId, Resources res) {
        try {
            ...
            if (isSrc)
                ...
                //setBackground(d);
                CompatibilityUtilsImpl.setBackground(this, d);
            else
