...
import ua.in.quireg.chan.views.controls.SelectiveViewPager;
...
//    }
    ...
    private void setThumbnail(final AttachmentInfo attachment, GalleryItemViewBag viewBag) {
        ...
        mToast = Toast.makeText(this, getResources().getString(R.string.notification_video), Toast.LENGTH_SHORT);
        mToast.show();
    }
