...
public class PostResponseParserTest extends InstrumentationTestCase {
	...
	public void testAddPostSuccess() throws SendPostException{
		...
		boolean result = mParser.isPostSuccessful(response);
		
		assertTrue(result);
	}
	
	public void testAddWithoutComment(){
		String response = "<hr style=\"clear: left;\">" +
				"<center>" +
				"<strong><font size=\"5\">Ошибка: Вы ничего не написали в сообщении.</strong></font><br />" +
				"<h2 style=\"text-align: center\">" +
				"<a href=\"http://2ch.so/test/res/52984.html\">Назад</a><br />" +
				"</h2>" +
				"</center>";
		
		String message = null;
		try{
			mParser.isPostSuccessful(response);
		}
	...
	public void testMultipleCenterBlocks(){
		String response = "<center>Irrelevant text<a href=\"/me/\" title=\"/me/\"><img style='border: 0px none;' src=\"/../ololo/me_1.png\"></a></center>"+
						"<center>Real error.<a href=\"http://2ch.so/test/\">Назад</a><br /></center>"+
						"<center>Irrelevant text<a></a></center>" ;
